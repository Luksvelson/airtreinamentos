...
export function Hero() {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center bg-gradient-to-br from-[#041F3F] via-[#041F3F] to-[#0a3566] overflow-hidden">
        ...
        <div className="text-center space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 pt-12 max-w-3xl mx-auto">
            {trustIndicators.map((indicator, index) => (
              <div
                key={index}
                className="flex flex-col items-center gap-2 p-4 rounded-lg bg-white/5 backdrop-blur-sm"
